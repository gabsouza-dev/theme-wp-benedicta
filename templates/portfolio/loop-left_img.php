...
$excerpt = benedicta_smarty_modifier_truncate($text, 110);
?>
			...
			<?php if( has_post_thumbnail() ) { ?>
				<div class="col-md-7 col-sm-6 portfolio_format_content">
					<a href="<?php the_permalink(); ?>">
						<?php the_post_thumbnail('benedicta_685x430'); ?>
					</a>
				</div>
			<?php } ?>
			<div class="col-md-4 col-sm-6 portfolio_descr_wrap">
				<span class="portfolio_meta_date"><?php the_time( get_option( 'date_format' ) ); ?></span>
