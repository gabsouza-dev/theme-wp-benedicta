...
$benedicta_post_audio_embed = get_post_meta($post->ID, 'benedicta_post_audio_embed', true);
		...
		<?php if ( !is_single() ) { ?>
			<div class="post-image">
				<a href="<?php echo esc_url( the_permalink() ); ?>">
					...
					<div class="play_btn"><span></span><i class="fa fa-music"></i></div>
				</a>
			</div>
		<?php } else { ?>
			<div class="post-audio">
				<?php echo apply_filters( "the_content", wp_specialchars_decode( $benedicta_post_audio_embed ) ); ?>
			</div>
		<?php } ?>
	<?php } ?>