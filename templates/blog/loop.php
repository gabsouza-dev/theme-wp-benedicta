...
if( is_home() || is_category() || is_tag() || is_day() || is_month() || is_year() ) { 
	if( $benedicta_sidebar_layout == 'left-sidebar' || $benedicta_sidebar_layout == 'right-sidebar' ) {
		$excerpt_count = 300;
	} else {
		$excerpt_count = 550;
	}
...
?>
		...
		<div class="post-content-wrapper clearfix">
			...
			<?php if( $benedicta_pf != 'quote' && $benedicta_pf != 'link' ) { ?>
